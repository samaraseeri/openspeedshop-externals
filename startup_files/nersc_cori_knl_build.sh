...
module load /opt/cray/pe/craype/2.5.5/modulefiles/craype-mic-knl 
...
module unload /opt/cray/pe/craype/2.5.5/modulefiles/craype-mic-knl 
module load /global/homes/j/jgalaro/privatemodules/cori-cmake-3.2.2
#module load cudatoolkit
