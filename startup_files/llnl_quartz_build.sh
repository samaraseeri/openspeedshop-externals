...
export BASE_IDIR=/usr/global/tools/openspeedshop/oss-dev/x8664/quartz
export ROOT_VERS="_v2.3.1"
export TOOL_VERS="_v2.3.1"
...
./install-tool --build-krell-root --krell-root-prefix ${KROOT_IDIR} --with-openmpi ${OPENMPI_IDIR} --with-mvapich2 ${MVAPICH2_IDIR} --with-mpich ${MPICH_IDIR}  --force-libdwarf-build
